...
Kokkos exposes its type traits as C++20 Concepts
\newline
\begin{columns}
\begin{column}{.5\linewidth}
  \begin{itemize}
...
\end{columns}
\vspace{10pt}
\begin{code}[keywords={template}]
// Old SFINAE way
template <class ExecutionPolicy, class FunctorType,
          class Enable =
              std::enable_if_t<is_execution_policy_v<ExecutionPolicy>>>
// New Concepts way
template <Kokkos::ExecutionPolicy ExecutionPolicy, typename FunctorType>
  \end{code}
\end{frame}
