...
Currently, we can't use the same functor to be used in a top-level parallel construct or hierarchical parallelism. The following is allowed in the future:
\begin{code}
