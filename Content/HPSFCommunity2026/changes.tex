...
\date{HPSF Community Summit 2026, 02/27/2026}
...
\begin{frame}[fragile]{SYCL reaches production-level support}
  \begin{itemize}
    \item Development started in 3.3.00 matu    ring and tracking changes to hardware and software for Aurora and its testbeds
